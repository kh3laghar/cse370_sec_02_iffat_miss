...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "UpdateForm")) {
  $insertSQL = sprintf("INSERT INTO billing_details (bill_id, advance_amount, total_amount) VALUES (%s, %s, %s)",
...
<table width="400" border="0" align="center">
  ...
  <tr>
    <td><span id="sprytextfield3"> Billing Id : <br>
      <input name="BillId" type="text" class="styleTxtField" id="BillId" value="<?php echo $row_BillingDetails['bill_id']; ?>">
