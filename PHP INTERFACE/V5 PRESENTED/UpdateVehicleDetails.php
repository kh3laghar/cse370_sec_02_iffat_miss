...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "UpdateForm")) {
  $updateSQL = sprintf("UPDATE vehicle_details SET vechicle_status=%s WHERE vehicle_id=%s AND vehicle_reg_no=%s",
                       GetSQLValueString($_POST['AvailablelStatus'], "int"),
...
mysql_select_db($database_user_info, $user_info);
$query_Recordset1 = "SELECT * FROM vehicle_details";
  ...
  <tr>
            ...
            <tr>
              <td><span id="sprytextfield5">
                Vehicle ID : <br>
                <input name="VehicleID" type="text" class="styleTxtField" id="VehicleID">
            ...
            <tr>
              <td><span id="sprytextfield3">
                Registration No : :<br>
                <input name="Registration" type="text" class="styleTxtField" id="Registration">
                <span class="textfieldRequiredMsg">A value is required.</span></span></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            ...
            <tr>
              <td><span id="spryselect2">
                <select name="AvailablelStatus" class="styleTxtField" id="AvailablelStatus">
                  <option value="1" <?php if (!(strcmp(1, $row_Recordset1['vechicle_status']))) {echo "selected=\"selected\"";} ?>>Yes</option>
                  <option value="0" <?php if (!(strcmp(0, $row_Recordset1['vechicle_status']))) {echo "selected=\"selected\"";} ?>>No</option>
                </select>
            ...
            <tr>
              <td><input type="submit" name="UpadateDate" id="UpadateDate" value="Update">
                <input name="UserIDHidded" type="hidden" id="UserIDHidded" value="<?php echo $row_Recordset1['vehicle_id']; ?>"></td>
            </tr>
</table></td>
      </tr>
      <tr>
