...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "UpdateForm")) {
  $insertSQL = sprintf("INSERT INTO vehicle_details (vehicle_id, vehicle_reg_no, vechicle_status) VALUES (%s, %s, %s)",
...
<table width="400" border="0" align="center">
  ...
  <tr>
    <td><span id="sprytextfield2"> Vehicle Id : <br>
      <input name="text1" type="text" class="styleTxtField" id="text1">
