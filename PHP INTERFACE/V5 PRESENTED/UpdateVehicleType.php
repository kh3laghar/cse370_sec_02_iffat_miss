...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "UpdateForm")) {
  $updateSQL = sprintf("UPDATE vehicle_type SET name=%s, Model=%s, Color=%s, deposit=%s, cost_per_mile=%s, `Seat Quantity`=%s, availbility_vechicle=%s WHERE vehicle_id=%s",
                       ...
                       GetSQLValueString($_POST['Seat_status'], "int"),
                       GetSQLValueString($_POST['Available_dec'], "text"),
                       GetSQLValueString($_POST['VehicleDetails'], "int"));

  mysql_select_db($database_user_info, $user_info);
  $Result1 = mysql_query($updateSQL, $user_info) or die(mysql_error());

  $updateGoTo = "UpdateVehicleType.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    ...
    <table width="600" border="0">
      <tr>
        <td height="26"><p>&nbsp;</p>
          ...
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>Account Info : <?php echo $row_user['FName']; ?>    User Name : <?php echo $row_user['user_id']; ?>
          </p>
      ...
      <tr>
        <td><table width="500" border="0" align="center">
          ...
          <tr>
            <td><span id="sprytextfield8"> Vechicle ID : <br>
              <input name="VehicleDetails" type="text" class="styleTxtField" id="VehicleDetails">
...
Cost Per Mile : <br>
          ...
          <tr>
            <td><span id="sprytextfield6"> Seat Quantuty : <br>
              <input name="Seat_status" type="text" class="styleTxtField" id="Seat_status">
              <span class="textfieldRequiredMsg">A value is required.</span></span></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            <td><span id="sprytextfield7"> Color : <br>
              <input name="Color" type="text" class="styleTxtField" id="Color">
              <span class="textfieldRequiredMsg">A value is required.</span></span></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            <td><span id="sprytextfield5">
              Available :<br>
              <input name="Available_dec" type="text" class="styleTxtField" id="Available_dec">
              <span class="textfieldRequiredMsg">A value is required.</span></span></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          ...
          <tr>
            <td><span id="spryselect2">
              ...
              <input type="submit" name="Add" id="Add" value="Insert"></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
