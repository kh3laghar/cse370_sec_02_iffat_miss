...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2015 at 06:31 PM
...
-- Last update: Jul 25, 2015 at 04:51 PM
--
...
INSERT INTO `billing_details` (`bill_id`, `book_id`, `advance_amount`, `total_amount`, `bill_status`, `bill_date`) VALUES
...
INSERT INTO `customer_datails` (`cust_id`, `FName`, `LName`, `user_id`, `UserLevel`, `password`, `email_id`, `PhoneNo`, `address_user`, `timestamp`) VALUES
...
INSERT INTO `driver_details` (`driver_id`, `name`, `gender`, `dob`, `status`, `email_id`, `address_driver`) VALUES
...
INSERT INTO `vehicle_details` (`vehicle_id`, `vehicle_reg_no`, `vechicle_status`) VALUES
(1, 121314155, 1),
...
--
-- Creation: Jul 13, 2015 at 11:11 AM
-- Last update: Jul 28, 2015 at 03:43 AM
--
...
INSERT INTO `vehicle_type` (`vehicle_id`, `name`, `Model`, `deposit`, `cost_per_mile`, `availbility_vechicle`) VALUES
(1, 'Asiful haque', '', 1500, 1266, 1),
(12201011, 'Asiful haque', '', 1500, 1266, 1),
(12201012, 'das', 'dsd', 1200, 1200, 1),
(12201013, 'asd', 'asdasda', 1500, 15, 1),
(12201014, 'toyota', 'sedan', 1300, 65, 1);
...
--
ALTER TABLE `billing_details`
MODIFY `bill_id` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
